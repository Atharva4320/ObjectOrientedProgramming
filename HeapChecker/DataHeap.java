...
/** Class DataHeap
 * This class handles creating heaps which contain data.
 */
public class DataHeap extends DataBT implements IHeap {
    ...
    /**Method getLeft() gives the left sub-tree of the heap
     *
     * @return the IHeap data structure of the left sub-tree
     */
    @Override
    ...
    /**Method getRight() gives the right sub-tree of the heap
     *
     * @return the IHeap data structure of the right sub-tree.
     */
    @Override
